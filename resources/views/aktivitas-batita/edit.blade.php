...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <h3>Edit Jadwal Aktivitas Batita</h3>
        </div>
    </div>

    <div class="clearfix"></div>

    <form method="POST" id="validate_form" action="{{route('aktivitas-batita.update', $datas->id)}}" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('put') }}
        <div class="row">
                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 ">
                                    <input name="kategori_aktivitas" type="text" id="kategori_aktivitas" class="form-control" value="Batita" hidden>
                                </div>
                            </div>
