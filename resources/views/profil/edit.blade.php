...
<div class="">
    ...
    <form method="POST" id="validate_form" action="{{route('profil.update')}}" enctype="multipart/form-data">
        @method('patch')
        @csrf
        <div class="row">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <a href="{{route('profil.index')}}"><button class="btn btn-danger" type="button">Batal</button></a>
