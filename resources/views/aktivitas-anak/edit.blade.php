...
<div class="">
    <div class="page-title">
        <div class="title_left">
            <h3>Edit Jadwal Aktivitas Anak</h3>
        </div>
    </div>

    <div class="clearfix"></div>

    <form method="POST" id="validate_form" action="{{route('aktivitas-anak.update', $datas->id)}}" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('put') }}
        <div class="row">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
                                <div class="col-md-6 col-sm-6 offset-md-3">
                                    <a href="{{route('aktivitas-anak.index')}}"><button class="btn btn-danger" type="button">Batal</button></a>
